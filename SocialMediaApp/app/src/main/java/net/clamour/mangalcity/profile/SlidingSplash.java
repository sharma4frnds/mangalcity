...
public class SlidingSplash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // LoginPrefrences = this.getSharedPreferences("net.clamour.mangalcity.profile.LoginActivity", MODE_PRIVATE);
        ...
        layouts = new int[]{
                R.layout.sliding_splash1,
                R.layout.sliding_splash2,
                R.layout.sliding_splash3,
                R.layout.sliding_splash4,
...
//        prefManager.setFirstTimeLaunch(false);
        startActivity(new Intent(SlidingSplash.this, LoginActivity.class));
        finish();
    }
