...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    private ArrayList<MediaImageResponse> images;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        images = (ArrayList<MediaImageResponse>) getArguments().getSerializable("images");
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ImageView downloadImage=(ImageView)view.findViewById(R.id.downloadImage) ;

           final MediaImageResponse image = images.get(position);

            downloadImage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                        Glide.with(getActivity())
                                .load("http://emergingncr.com/mangalcity/public/images/post/post_image/" + image.getName())
                                .asBitmap()
...
//                }
            ...
            Glide.with(getActivity()).load("http://emergingncr.com/mangalcity/public/images/post/post_image/" +image.getName())
                    .thumbnail(0.5f)
                    .crossFade()
